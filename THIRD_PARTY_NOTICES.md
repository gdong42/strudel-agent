...
(https://github.com/githubnext/monaspace), with Reserved Font Name
"Monaspace", including subfamilies "Argon", "Neon", "Xenon", "Radon", and
"Krypton".

Both font families are distributed under the following license.
